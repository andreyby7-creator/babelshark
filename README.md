...
**Зачем этот репозиторий:** тестовое задание с чётким разделением «live SQL → Minimongo» и «переводы через ORM», плюс Vitest (юниты и интеграция со стабами) без полного рантайма Meteor.
